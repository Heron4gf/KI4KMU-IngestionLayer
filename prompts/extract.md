...
4. **tags**: An array of tags that categorize this section. Tags must follow the quality rules below.
...
**Expected output:**
```json
{"sections": [{"section_id": "engine_compression_ratio", "label": "Engine Compression Ratio", "texts": [{"content": "compression ratio Chassis 3413G between 1 and 3 bars"}], "tags": [{"label": "chassis"}, {"label": "compression"}]}]}
```
...
**Expected output:**
```json
{"sections": [{"section_id": "cpu_specifications", "label": "2.4 CPU Specifications", "texts": [{"content": "Ryzen 9 5950X operates at base clock 3.4 GHz boost clock 4.9 GHz"}], "tags": [{"label": "processor"}, {"label": "clock speed"}]}]}
```
...
## Tag Quality Rules
- Tags must aid retrieval — ask: "would someone search for this term?" If not, omit it.
